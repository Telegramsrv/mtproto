...
use MyApp\Entities\CallbackQuery;
use MyApp\Entities\Chat;
use MyApp\Entities\ChosenInlineResult;
use MyApp\Entities\InlineQuery;
use MyApp\Entities\Message;
use MyApp\Entities\ReplyToMessage;
use MyApp\Entities\Update;
use MyApp\Entities\User;
use MyApp\Exception\TelegramException;
use PDO;
use PDOException;
...
class DB
{
     ...
     * @param \MyApp\Telegram $telegram     Telegram object to connect with this object
     ...
     *
     * @param  \MyApp\Entities\User $user
     * @param  string                             $date
     * @param  \MyApp\Entities\Chat $chat
     *
     * @return bool If the insert was successful
     * @throws \MyApp\Exception\TelegramException
     */
     ...
     *
     * @param \MyApp\Entities\InlineQuery $inline_query
     *
     * @return bool If the insert was successful
     * @throws \MyApp\Exception\TelegramException
     */
     ...
     *
     * @param \MyApp\Entities\ChosenInlineResult $chosen_inline_result
     *
     * @return bool If the insert was successful
     * @throws \MyApp\Exception\TelegramException
     */
     ...
     *
     * @param \MyApp\Entities\CallbackQuery $callback_query
     *
     * @return bool If the insert was successful
     * @throws \MyApp\Exception\TelegramException
     */
     ...
     *
     * @param \MyApp\Entities\Message $message
     *
     * @return bool If the insert was successful
     * @throws \MyApp\Exception\TelegramException
     */
     ...
     *
     * @param \MyApp\Entities\Message $edited_message
     *
     * @return bool If the insert was successful
     * @throws \MyApp\Exception\TelegramException
     */
