...
class ServerResponse extends Entity
{
     ...
     * @param string $bot_name
     *
     * @return \MyApp\Entities\Chat|\MyApp\Entities\ChatMember|\MyApp\Entities\File|\MyApp\Entities\Message|\MyApp\Entities\User|\MyApp\Entities\UserProfilePhotos|\MyApp\Entities\WebhookInfo
     * @throws \MyApp\Exception\TelegramException
     */
     ...
     * @param string $bot_name
     *
     * @return null|\MyApp\Entities\ChatMember[]|\MyApp\Entities\Update[]
     * @throws \MyApp\Exception\TelegramException
     */
